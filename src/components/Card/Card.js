  ...
  return (
    <>
      ...
      <Box  borderWidth='1px' borderRadius='lg' overflow='hidden'  ml="1em" mr='1em' position='relative' width="300px"  mt='2em'>
        ...
        <Synopsis synopsis={props.synopsis} url={props.url} title={props.title} episodes={props.episodes} duration={props.duration} trailerurl={props.trailerurl} myFunction={props.myFunction} />
      </Box>
